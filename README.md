...
![Shader](https://img.shields.io/badge/-Shader-3b82f6?style=flat&labelColor=0a0a0a&logo=opengl&logoColor=white)
**Live on:** `VS Code` · `Open VSX` · `Zed` · `Sublime (Package Control)` · `JetBrains Marketplace` · `Ghostty + 30 terminals`

### [npmguard](https://github.com/AyoubTadlaoui/npmguard) — pre-install risk gate for npm
